...
export interface ApiBirthstoneBirthstone extends Struct.CollectionTypeSchema {
  collectionName: 'birthstones';
  info: {
    description: 'Monthly birthstones and their associations';
    displayName: 'Birthstone';
    pluralName: 'birthstones';
    singularName: 'birthstone';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Organize content and products into categories';
...
export interface ApiMetalMetal extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Metal types for jewelry (Gold, Platinum, Silver, etc.)';
    displayName: 'Metal';
    pluralName: 'metals';
    singularName: 'metal';
  };
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Jewelry products for the e-commerce platform';
    displayName: 'Product';
    pluralName: 'products';
  ...
  attributes: {
    birthstoneMonth: Schema.Attribute.Relation<
      'manyToOne',
      'api::birthstone.birthstone'
    >;
    category: Schema.Attribute.Relation<'manyToOne', 'api::category.category'>;
    ...
    style: Schema.Attribute.Relation<'manyToOne', 'api::style.style'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiRetailerRetailer extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Jewelry retailers and vendors';
  ...
  attributes: {
    ...
    rating: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    returnPolicy: Schema.Attribute.Component<'retailer.return-policy', false>;
    shippingPolicy: Schema.Attribute.Component<
      'retailer.shipping-policy',
      false
    >;
    slug: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
    socialMedia: Schema.Attribute.Component<'shared.social-links', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiStyleStyle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Jewelry design styles (Solitaire, Halo, Vintage, etc.)';
    displayName: 'Style';
    pluralName: 'styles';
    singularName: 'style';
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::birthstone.birthstone': ApiBirthstoneBirthstone;
